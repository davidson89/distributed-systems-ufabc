...
public class AcessoImpl extends UnicastRemoteObject implements InterfaceAcesso{
	...
	@Override
	public Object recupera(int id) throws RemoteException,ObjetoNaoEncontradoException {
		
	Object ob = this.instacia.retornaObjeto(id);
	if (ob == null) throw new ObjetoNaoEncontradoException("Objeto de id " + id + " não encontrado");
	return ob;
	}
